                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3 px-4 py-3 rounded-xl glass-card reveal">
                            ...
                            <span className="text-gray-600 text-sm">
                                ...
                                {' '}<span className="text-gray-900 font-medium">clean architecture</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 reveal">
                        <div className="glass-card rounded-2xl p-6 sm:p-8">
                            ...
                            <div className="space-y-4 text-gray-600 text-base leading-relaxed">
                                <p>
                                    With <span className="text-gray-900 font-medium">5+ years</span> of hands-on Flutter
                                ...
                                <p>
                                    I've delivered <span className="text-gray-900 font-medium">50+ apps</span> across fintech,
